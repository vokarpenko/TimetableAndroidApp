...
public class NewsFragment extends Fragment implements NewsView {
    ...
    private void init() {
        ...
        Sprite spriteMiddleBar = new ChasingDots();
        spriteMiddleBar.setColor(getResources().getColor(R.color.colorPrimary));
        progressBar.setIndeterminateDrawable(spriteMiddleBar);
        bottomProgressBar = view.findViewById(R.id.progress_bar_bottom);
        Sprite spriteBottomBar = new ChasingDots();
        spriteBottomBar.setColor(getResources().getColor(R.color.colorPrimary));
        bottomProgressBar.setIndeterminateDrawable(spriteBottomBar);
